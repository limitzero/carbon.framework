...
namespace Carbon.Core.Stereotypes.For.MessageHandling.Aggregator
{
    /// <summary>
    ...
    /// }
    /// 
    ///  public class OrderToInvoiceAggregatorStrategy : BaseAggregatorStrategy{Order}
    ///  {
    ...
    /// to be inspected for "completed" status:
    /// 
    /// [MessagingEndpoint("billing", "shipping")]
    /// public class OrderToInvoiceAggregator
    /// {
